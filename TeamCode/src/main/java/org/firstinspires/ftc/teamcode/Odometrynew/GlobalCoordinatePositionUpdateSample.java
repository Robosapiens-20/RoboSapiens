 ...
 */
@TeleOp(name = "Global Coordinate Position Test Retry", group = "Calibration")
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String verticalLeftEncoderName = "front_right", verticalRightEncoderName = "back_right", horizontalEncoderName = "front_left";
...
//        horizontal.setDirection(DcMotorSimple.Direction.REVERSE);
     ...
     //   globalPositionUpdate.reverseLeftEncoder();
        while(opModeIsActive()){
            ...
            telemetry.addData("vertical left position", 0);
