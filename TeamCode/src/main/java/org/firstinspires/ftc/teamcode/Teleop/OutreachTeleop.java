...
public class OutreachTeleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            currentStateofA1 = g1.left_bumper;
            currentStateofB2 = g1.b;
            currentStateofA = g2.a;
            currentStateofB = g2.b;
            currentStateofX = g1.right_bumper;
            ...
            telemetry.addData("motor position", backRight.getCurrentPosition());
            telemetry.update();


            if (g1.left_bumper && currentStateofA1 != false) {
                AutoServo.setPosition(0.35);
            }

            if (g1.right_bumper && currentStateofX != false) {
